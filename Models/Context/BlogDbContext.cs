...
public class BlogDbContext: DbContext
{
     ...
     protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>()
            ...
            .OnDelete(DeleteBehavior.SetNull); // En caso de borrar el rol, el usuario no se borra
        ...
        modelBuilder.Entity<Session>()
            ...
            .OnDelete(DeleteBehavior.Restrict); // No permitir eliminar el usuario si tiene una sesión
        ...
        modelBuilder.Entity<Article>()
            ...
            .OnDelete(DeleteBehavior.Cascade); // Si el usuario es eliminado, los artículos también
        ...
        modelBuilder.Entity<AuditLog>()
            ...
            .OnDelete(DeleteBehavior.Restrict); // No eliminar el usuario si tiene logs de auditoría
        ...
        modelBuilder.Entity<AuditLog>()
            ...
            .OnDelete(DeleteBehavior.Restrict); // No eliminar el artículo si tiene logs de auditoría

        // Otras configuraciones para las entidades
